...
<body>
	...
	<div class="container">
		...
		<div class="row">
			...
			<h4><font size="4" color="black">For the entire Program Increment PI-400 = 5500 Story Points</font></h4>	
				</hr>	
...
LEFT OUTER JOIN trains_and_teams t ON c.team_id = t.team_id
WHERE program_increment = 'pi-400'";
						$result = run_sql($sql);
		...
		<a href="capacity_summary3.php" style="background-color: #1E90FF;color: black;padding: 20px;text-align: center;display: inline-block;font-size: 16px;margin: 4px 2px; border-radius: 12px;">Show Previous PI</a>
		&nbsp
